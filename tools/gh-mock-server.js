  ...
  handleGraphQL(req, res, match) {
    ...
    this.readBody(req, (body) => {
      ...
      if (selections.reviewThreads) {
        ...
        // Filter threads by PR number only
        // Note: GitHub's API does NOT support a 'resolved' argument on reviewThreads
        // All threads are returned; filtering by resolution status happens client-side
